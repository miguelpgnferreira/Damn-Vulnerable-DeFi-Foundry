...
import "src/src-default/free-rider/FreeRiderBuyer.sol";
import "src/src-default/free-rider/FreeRiderNFTMarketplace.sol";

import "src/src-default/DamnValuableNFT.sol";
import "src/src-default/DamnValuableToken.sol";
import "src/src-default/WETH9.sol";

import "forge-std/Test.sol";

contract FreeRiderFixture is Test {
    //
    // Constants
    //
    ...
    function setUp() public virtual {
        ...
        router.call{value: UNISWAP_INITIAL_WETH_RESERVE}(
        ...
        (, bytes memory data) =
            factory.call(abi.encodeWithSignature("getPair(address,address)", address(token), address(weth)));
