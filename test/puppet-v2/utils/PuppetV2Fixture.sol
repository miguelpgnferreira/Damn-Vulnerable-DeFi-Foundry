...
contract PuppetV2Fixture is Test {
    //
    // Constants
    //
    ...
    function setUp() public virtual {
        ...
        factory.call(abi.encodeWithSignature("getInitHash()")); //  change UniswapV2Library INIT_CODE_HASH for this without 0x
        ...
        // Deploy the pool
        pool = deployCode("PuppetV2Pool.sol", abi.encode(address(weth), address(token), address(exchange), factory));
